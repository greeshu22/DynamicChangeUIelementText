		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comanjalidynamicuielements-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comanjalidynamicuielements-display": {
								"semanticObject": "comanjalidynamicuielements",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.anjali.dynamicuielements",
									"url": sap.ui.require.toUrl("com/anjali/dynamicuielements")
								}
							}
						}
					}
